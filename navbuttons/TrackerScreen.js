    ...
    <View style={styles.container}>
      ...
      <View style={styles.fillOut}>
        <View style={styles.trackerButtons}>
          ...
          <Pressable style={styles.sleepButton} onPress={goToSleepTracker}>
            <Image source={sleep} style={styles.image} />
              <Text style={[styles.boldText, styles.biggerText]}> Sleep Tracker</Text>
          ...
          <Pressable style={styles.heartButton} onPress={goToHeartRate}> 
            <Image source={heart} style={styles.image} />
              <Text style={[styles.boldText, styles.biggerText]}> Heart Rate</Text>
            <Image source={next} style={styles.next} />
          </Pressable>
