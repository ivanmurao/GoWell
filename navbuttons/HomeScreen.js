    ...
    <View style={styles.container}>
      ...
      <View style={styles.fillOut}>
        ...
        <View style={styles.topContainers}>
          ...
          <Pressable style={styles.containerBox1} onPress={goToSleepTracker}>
            <Text style={styles.title}>Sleep Tracker</Text>
            <Image source={sleep} style={styles.icon} />
          </Pressable>
        ...
        <View style={styles.bottomContainers}>
          ...
          <Pressable style={styles.containerBox4} onPress={goToHeartRate}>
